...
public class ZobristHash {
    ...
    /**
     * Get the Hash Key for a move of a piece from an initial position to a final one
     *
     * @param init_pos
     * @param final_pos
     * @param piece
     * @return
     */
   /* public static long getKeyForMove(int init_pos, int final_pos, char piece) {
        //Using of the XOR to get a move : XORing in the piece at the final_pos
        return getKeyForSquare(piece,init_pos) ^ getKeyForSquare(piece, final_pos);
    }*/
    public static long getKeyForBoard(Board board) {
        long key = 0;

        for (int pos = 0; pos < 64; pos++) {
            Piece p = board.getPiece(new Position((pos % 8), (pos/8)));
            if(p != null)
                key ^= getKeyForSquare(p, pos);
        }
/*
// TODO: 22/05/2017 Voir si on a un bool pour dire que le roi a roc ou pas
...
// TODO: 22/05/2017 Savoir qui doit joué
